...
# ## Load seasons information to sqllite
...
seasons_time=pd.read_csv(f"{DATASET_LOC}/input/seasons/cl_farmers_s1time.csv")
seasons_time.to_sql("fm_seasons_times", conn, if_exists="replace")
